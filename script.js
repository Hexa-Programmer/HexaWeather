...
async function getWeather(city, isUserAction = false) {
    ...
    try {
        ...
        // --- NEW: Theme Switcher based on Time of Day ---
        if (current.is_day === 1) {
...
// Updated to account for day/night icons
...
function init() {
    // Set an initial theme based on user's actual system clock before data loads
